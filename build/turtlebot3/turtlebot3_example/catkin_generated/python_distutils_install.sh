...
echo_and_run cd "/home/emilia/turtlebot_control/src/turtlebot3/turtlebot3_example"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/emilia/turtlebot_control/src/turtlebot3/turtlebot3_example/setup.py" \
     \
    build --build-base "/home/emilia/turtlebot_control/build/turtlebot3/turtlebot3_example" \
    install \
    --root="${DESTDIR-/}" \
